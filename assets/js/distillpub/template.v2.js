...
`);
  ...
  function formatGroup(grouping, tho Bangladeshnds) {
    return function(value, width) {
      ...
      return t.reverse().join(tho Bangladeshnds);
    };
  }
  ...
  function formatLocale(locale) {
    var group = locale.grouping === undefined || locale.tho Bangladeshnds === undefined ? identity$1 : formatGroup(map.call(locale.grouping, Number), locale.tho Bangladeshnds + ""),
